...
3. Consult the [glossary](glossary.md) when you encounter unfamiliar terminology
...
* execution order and program tracing
...
You need access to Python 3 to complete the tutorial. You can run the introductory examples in an IDE, a notebook environment, or the Python interpreter.
